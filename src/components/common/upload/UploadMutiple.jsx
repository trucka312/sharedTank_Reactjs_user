...
export default function UploadMultiple({
  ...
  const handleImageChange = (event) => {
    ...
    const uploadNextImage = (index) => {
      ...
      setLoading(true);
      axios
        .post("https://dev-zin.ikitech.vn/api/images", formData)
        .then((response) => {
