import { CameraOutlined, CloseCircleOutlined, DeleteOutlined, EditOutlined, VideoCameraAddOutlined } from "@ant-design/icons";
...
export default function UploadVideo({
  ...
  const handleVideoChange = (event) => {
    ...
    setLoading(true);
    axios
      .post("https://dev-zin.ikitech.vn/api/videos", formData)
      .then((response) => {
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          >
            {video ? (
              ...
              <span>
                <div className="flex flex-col items-center"><VideoCameraAddOutlined /><span className="xs:text-[8px]">{text}</span> </div>
              </span>
            )}
          </div>
